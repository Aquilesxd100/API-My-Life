...
namespace my_life_api.ValidatorsFilters.Record
{
    public class DeleteRecordSecondaryImgValidationFilter : ICustomActionFilter
    {
        public override async Task OnActionExecutionAsync(
            ...
            if (imgToDelete == null) {
                throw new CustomException(404, "Esse registro não tem uma imagem secundária com esse id.");
            }

            context.HttpContext.Request.Headers.Add("requestedItem", JsonConvert.SerializeObject(imgToDelete));
