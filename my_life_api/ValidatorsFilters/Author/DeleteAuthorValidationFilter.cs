    ...
    public class DeleteAuthorValidationFilter : ICustomActionFilter
    {
        public override async Task OnActionExecutionAsync(
            ...
            if (string.IsNullOrEmpty(authorId)) {
                throw new CustomException(400, "O param 'idAutor' é obrigatório e não foi informado.");
            }
            ...
            context.HttpContext.Request.Headers.Add("requestedItem", JsonConvert.SerializeObject(author));
